...
This version has been tested on GeneMapper ID-X 1.6 (both Client and Full installations).
...
- 1.03: Added initial warnings. Changed language to English (19/08/2026).
